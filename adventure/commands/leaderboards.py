...
# -*- coding: utf-8 -*-
"""
Leaderboard commands for GeneralsRPG.
"""

from redbot.core import commands
from redbot.core.i18n import Translator
from adventure.ui.menus import LeaderboardMenu, LeaderboardSource
...
class LeaderboardCommands:
    ...
    async def leaderboard(self, ctx: commands.Context):
        ...
        # TODO: fetch leaderboard data from config
        entries = [(ctx.author.id, {"rebirths": 1, "lvl": 10, "set_items": 2})]
        menu = LeaderboardMenu(source=LeaderboardSource(entries), cog=self)
