# -*- coding: utf-8 -*-
"""
Rebirth commands logic moved into core for organization; this is a copy of
existing implementation so tests and runtime keep working during migration.
"""
import logging
import time
...
from adventure.charsheet import Character, has_funds
from adventure.helpers import ConfirmView, escape, smart_embed
